...
const documents: Documents = {
  "\n  query ImagingDeviceAnalytics($deviceSlug: String!, $period: String) {\n    imagingDeviceAnalytics(deviceSlug: $deviceSlug, period: $period) {\n      deviceSlug\n      deviceId\n      deviceName\n      hospital\n      department\n      period\n      stats {\n        totalImages\n        imagesPerHour\n        imagesPerDay\n        imagesPerWeek\n        imagesPerMonth\n        estimatedOperatingHours\n        averageStudiesPerPatient\n        utilizationPercentage\n      }\n      workload {\n        hourly {\n          label\n          value\n        }\n        daily {\n          label\n          value\n        }\n        weekly {\n          label\n          value\n        }\n        monthly {\n          label\n          value\n        }\n        busiestHour\n        busiestDay\n        peakOperatingHours\n        lowestOperatingHours\n        underutilizedPeriods\n      }\n      health {\n        level\n        reasons\n      }\n      predictions {\n        label\n        riskScore\n        riskLevel\n        recommendation\n      }\n      recommendations\n    }\n  }\n":
    types.ImagingDeviceAnalyticsDocument,
  "\n  query PredictiveMaintenance {\n    predictiveMaintenance {\n      devices {\n        deviceSlug\n        deviceId\n        deviceName\n        hospital\n        department\n        period\n        stats {\n          totalImages\n          estimatedOperatingHours\n          utilizationPercentage\n        }\n        health {\n          level\n          reasons\n        }\n        predictions {\n          label\n          riskScore\n          riskLevel\n          recommendation\n        }\n        recommendations\n      }\n    }\n  }\n":
    types.PredictiveMaintenanceDocument,
  "\n  mutation GenerateAnalyticsReport($deviceSlug: String!, $period: String) {\n    generateAnalyticsReport(deviceSlug: $deviceSlug, period: $period) {\n      id\n      deviceName\n      period\n      fileName\n      pdfBase64\n      createdAt\n    }\n  }\n":
    types.GenerateAnalyticsReportDocument,
  "\n  mutation Login($input: LoginInput!) {\n    login(input: $input) {\n      user {\n        id\n        name\n        email\n        phone\n        isPlatformAdmin\n        memberships {\n          role\n          organization {\n            id\n            name\n            type\n          }\n        }\n      }\n      accessToken\n      refreshToken\n      accessTokenExpiresAt\n    }\n  }\n":
    types.LoginDocument,
  "\n  mutation SignUp($input: SignUpInput!) {\n    signUp(input: $input) {\n      message\n    }\n  }\n":
