  ...
  return (
    <div className="space-y-6">
      ...
      <div className="shadow-sm rounded-lg border border-slate-200 bg-white p-5">
        ...
        <button
          className="mt-5 rounded-lg bg-teal-700 px-5 py-2.5 text-sm font-bold text-white disabled:opacity-60"
          disabled={loading}
      ...
      {lastReport ? (
        <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-emerald-800">
          ...
          <button
            className="mt-3 rounded-lg bg-white px-4 py-2 text-sm font-bold text-emerald-800"
            onClick={() =>
